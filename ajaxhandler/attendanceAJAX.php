...
require_once $path."/attendanceappp/database/database.php";
require_once $path."/attendanceappp/database/sessionDetails.php";
require_once $path."/attendanceappp/database/facultyDetails.php";
require_once $path."/attendanceappp/database/courseRegistrationDetails.php";
require_once $path."/attendanceappp/database/attendanceDetails.php";
...
if(isset($_REQUEST['action']))
{
    ...
    if($action=="downloadReport")
    {
        ...
        //$rv=$ado->saveAttendance($dbo,$sessionid,$courseid,$facultyid,$studentid,$ondate,$status);
         ...
         $filename="/attendanceappp/report.csv";
